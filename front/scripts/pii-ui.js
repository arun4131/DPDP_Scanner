...
function labelChipClass(label) {
  ...
  if (l.includes('phone') || l.includes('mobile'))  return 'pii-label-chip--phone';
  if (l.includes('password'))                        return 'pii-label-chip--password';
  if (l.includes('user') || l.includes('name'))      return 'pii-label-chip--user';
  if (l.includes('address') || l.includes('ip') || l.includes('mac')) return 'pii-label-chip--address';
  if (l.includes('pan') || l.includes('tan') || l.includes('cin') || l.includes('gstin')) return 'pii-label-chip--pan';
  if (l.includes('aadhaar') || l.includes('adhar') || l.includes('aadhar')) return 'pii-label-chip--aadhaar';
  if (l.includes('passport') || l.includes('voter') || l.includes('driving') || l.includes('vehicle')) return 'pii-label-chip--id';
  if (l.includes('credit') || l.includes('debit') || l.includes('card') || l.includes('cvv') || l.includes('micr')) return 'pii-label-chip--card';
  if (l.includes('bank') || l.includes('account') || l.includes('ifsc') || l.includes('upi') || l.includes('loan') || l.includes('demat') || l.includes('cheque') || l.includes('cif') || l.includes('fastag')) return 'pii-label-chip--bank';
