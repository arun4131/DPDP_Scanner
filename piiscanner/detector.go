...
const (
	...
	// Currently supported for India.
	// Detection is based on column name + value length (6 digits).
...
type Detector interface {
	...
	Detect(ctx context.Context, word string, hasColumnContext bool) ([]PiiLabelWithWeight, error)
}
